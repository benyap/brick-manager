      ...
      <div>
        <div className="flex flex-col-reverse lg:flex-row justify-between">
          <div className="mb-4">
            ...
            <p className="text-lego-navy-200 text-xl lg:text-2xl font-semibold">
              {rgb}
            </p>
          </div>
          <div
            className="w-24 h-24 lg:w-28 lg:h-28 rounded-lg flex-shrink-0 border border-gray-300 shadow-md mb-4 lg:mb-0 lg:ml-4"
...
function VendorIDs(props: {
  ...
  return (
    <div>
      <h3 className="text-lego-navy-300 font-semibold lg:text-lg lg:mb-1">
        {name} ID
      </h3>
      <table>
        <tbody>
          {identifiers?.map(({ id, name }) => (
            <tr key={id} className="text-lego-navy-300 text-sm lg:text-base">
